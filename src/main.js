...
axios.interceptors.request.use(
  config => {
    ...
    //var token="7ceace472ce046909271fd0c90da2800"
    // if ((token.token) != null) {
    //   config.headers.Authorization = token.token;
    
    config.headers.Authorization='7ceace472ce046909271fd0c90da2800'
...
//     if(response.data.authorityStatus == 1){
//       alert("您没有权限,请重新登陆");
//       window.location.href = "http://192.168.1.131/archives/error.html"
//     }else if(response.data.authorityStatus == 2){
//       alert("登陆过期，请重新登陆");
